...
func (p *initSubcommand) UpdateContext(ctx *plugin.Context) { p.UpdateContext(ctx) }
func (p *initSubcommand) BindFlags(fs *pflag.FlagSet)       { p.BindFlags(fs) }
